...
export const sima = {
  ...
  photos: [
    ...
    { id: 'mirror', image: assetUrl('photos/sima-mirror.webp'), placeholder: 'SIMA_MIRROR', caption: 'Фінальна перевірка перед виходом.', funnyCaption: 'Дзеркало підтвердило: команда готова.', category: 'Звичайне', featured: false, alt: 'Сіма з другом фотографуються у дзеркалі', objectPosition: '50% 46%' },
  ...
  specifications: [
    ...
    ['Романтичний статус', 'Радник із досвідом. Дівчини ще немає.'],
  ...
  impact: {
    ...
    items: [
      { title: 'Ти залишаєш місце поруч.', body: 'Ти кличеш із собою так, що я не почуваюся гостем у чужій компанії.' },
      { title: 'Ти помічаєш раніше, ніж я прошу.', body: 'Коли мені потрібна опора, ти береш частину тягаря на себе — без гучних слів і без обов’язку.' },
      { title: 'Твої слова збігаються з учинками.', body: 'Я бачу це в тому, як ти ведеш молодіжку, тримаєш слово й залишаєшся поруч, коли відповідальність стає незручною.' },
      { title: 'Ти даєш чесні поради про стосунки.', body: 'Ти вмієш вислухати, помітити те, чого друг сам не бачить, і сказати правду без зайвого пафосу. Саме так ти допомагав мені розібратися в особистому житті. Тепер залишилося застосувати цей талант до власної історії.' },
    ],
  ...
  level24: {
    ...
    features: ['Досвід: +1 рік реальних рішень', 'Команда: збирається навіть без готового плану', 'Наставник Mode: працює без перезавантаження', 'Ландшафти: акуратність підвищено', 'Audi: маршрути все ще народжуються дорогою', 'Головне: друзі залишаються в пріоритеті'],
    cta: 'Що нового?',
  },
  ...
  insideJokes: [
    ...
    { id: 'level-secret', title: 'SimaOS 24.1', description: 'Модуль «поради для мого особистого життя» працює без збоїв. Модуль «власна дівчина» досі в бета-версії. Сімо, реліз уже час планувати.', hidden: true, trigger: 'age' },
