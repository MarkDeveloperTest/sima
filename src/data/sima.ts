...
export const sima = {
  ...
  mentor: {
    ...
    lines: [
      ...
      'Поруч із тобою я бачу, як віра, вірність і відповідальність проявляються у звичайних рішеннях.',
      'Ти не читаєш лекцій — ти просто живеш так, що хочеться ставати кращим.',
    ],
    notice: 'Я помічаю це.',
  ...
  impact: {
    ...
    intro: ['Ти вплинув на моє життя.', 'Не через один великий момент.', 'А через безліч маленьких.'],
    items: [
      { title: 'Ти залучаєш мене.', body: 'Ти запрошуєш мене й даєш відчути, що я справді є частиною всього.' },
      { title: 'Ти піклуєшся про мене.', body: 'Ти брав на себе відповідальність за мене, хоча не був зобов’язаний.' },
      { title: 'Ти ведеш власним прикладом.', body: 'Бачити, як старший бере на себе відповідальність, веде людей і залишається поруч, — це теж вчить мене.' },
    ],
    thanks: 'Дякую, бро.',
  },

  faith: {
    title: 'Ти допомагаєш мені рости.',
    quote: 'Як гострить залізо залізо, так гострить людина лице свого друга.',
    reference: 'Приповісті 27:17 · переклад Івана Огієнка',
    gratitude: 'Я вдячний Богові за людей, які впливають на мене, спонукають ставати кращим і допомагають рости.',
    personal: 'Ти — один із них.',
    blessingTitle: 'Нехай Бог благословить твій новий рік життя.',
    blessing: 'Нехай Бог дає тобі мудрість у кожному рішенні, силу нести відповідальність, надійних людей поруч і можливості, які перевершать твої очікування.',
    blessingMore: 'І нехай Він далі використовує тебе, щоб впливати на людей — навіть на тих, хто нечасто говорить тобі, що ти змінив щось у їхньому житті.',
  },
  ...
  insideJokes: [
    ...
    { id: 'level-secret', title: 'SimaOS 24.1', description: 'Виправлено: нічого. Покращено: лідерство, терпіння і здатність зібрати всіх одним повідомленням.', hidden: true, trigger: 'age' },
