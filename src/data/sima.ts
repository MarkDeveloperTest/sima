...
export const sima = {
  ...
  impact: {
    ...
    items: [
      ...
      { title: 'Ти був моїм любовним навігатором.', body: 'Коли моє особисте життя їхало без карти, ти підказував повороти й допомагав не звернути не туди. Дякую, бро. Тепер твоя черга прокласти маршрут до власної історії.' },
    ],
